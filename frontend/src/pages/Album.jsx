    ...
    <Layout>
      {albumData && (
        <>
          ...
          {albumSong.map((e, i) => (
            <div
              className="grid grid-cols-3 sm:grid-cols-4 mt-5 mb-4 pl-2 text-[#a7a7a7] hover:bg-[#ffffff2b] cursor-pointer"
              key={i}
            >
              <p className="text-white flex items-center">
                ...
                <img
                  src={e.thumbnail?.url || "/default.jpg"}
              ...
              <div className="flex justify-center items-center gap-5">
                <span onClick={() => savePlayListHandler(e._id)}>
                  <FaBookmark />
                </span>
                <span onClick={() => onclickHander(e._id)}>
                  <FaPlay />
                </span>
              </div>
            </div>
